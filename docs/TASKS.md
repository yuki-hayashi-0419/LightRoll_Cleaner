...
- [ ] **BUG-001: 自動スキャン設定の同期不整合修正**
  - 目的：ScanSettingsとBackgroundScanManagerの設定同期
  - 推定時間：5.5h
  - 担当：@spec-developer
  - 詳細：統合修正計画書参照（タスクB1-B5）

- [ ] **BUG-002: スキャン設定がグルーピングに反映されない問題修正**
  - 目的：includeSelfies等の設定をグルーピングロジックに反映
  - 推定時間：6.5h
  - 担当：@spec-developer
  - 詳細：統合修正計画書参照（タスクC1-C5）
...
- [ ] **UX-001: 二重バックボタン表示修正**
  - 目的：NavigationStackの自動バックボタンとカスタムバックボタンの重複解消
  - 推定時間：2.5h
  - 担当：@spec-developer
  - 詳細：統合修正計画書参照（タスクA1-A4）
...
*最終更新: 2025-12-23 (ui-scan-issues-analysis-001セッション完了)*
