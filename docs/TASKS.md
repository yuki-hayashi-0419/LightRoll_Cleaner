...
**M1残: 4タスク / 6.5時間** (完了: 6タスク / 7.5時間 -> アーカイブ済)
...
**M4残: 13タスク / 16時間** (完了: 1タスク / 1時間 -> アーカイブ済)
...
|------------|----------|--------|------------|
| M1: Core Infrastructure | 4 | 6.5h | 6 (7.5h) |
| M2: Photo Access | 12 | 20.5h | 0 |
| M3: Image Analysis | 13 | 25.5h | 0 |
| M4: UI Components | 13 | 16h | 1 (1h) |
...
| **残合計** | **111** | **181.5h** | **7 (8.5h)** |

*進捗: 7/118タスク完了 (5.9%) / 8.5h/190h (4.5%)*
