...
- **Entitlements File**: `Config/LightRoll_Cleaner.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/LightRoll_Cleaner.entitlements`:
